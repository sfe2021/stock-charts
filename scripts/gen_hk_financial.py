...
tencent = build_html(
    ...
    [
        ("Revenue",                ["560,118", "554,552", "609,015", "660,257"]),
        ("Operating Income",       ["122,341", "113,940", "165,658", "208,786"]),
        ("Operating Income (Reported)",  ["122,341", "113,940", "165,658", "208,786"]),
        ("Income Before Tax",         ["248,062", "210,225", "161,324", "241,485"]),
        ("Net Income",             ["227,810", "188,709", "118,048", "196,467"]),
        ("Net Income (Parent)",    ["224,822", "188,243", "115,216", "194,073"]),
        ("Net Income (NCI)",       ["2,988", "466", "2,832", "2,394"]),
        ("Total Assets",           ["1,612,364", "1,578,131", "1,577,246", "1,780,995"]),
        ("Total Liabilities",      ["735,671", "795,271", "703,565", "727,099"]),
        ("Total Equity",           ["876,693", "782,860", "873,681", "1,053,896"]),
        ("Equity (Parent)",        ["806,299", "721,391", "808,591", "973,548"]),
        ("Equity (NCI)",           ["70,394", "61,469", "65,090", "80,348"]),
        ("Paid-in Capital",           ["0", "0", "0", "0"]),
        ("Operating CF",           ["175,186", "146,091", "221,962", "258,521"]),
        ("Investing CF",           ["-178,549", "-104,871", "-125,161", "-122,187"]),
        ("Financing CF",           ["21,620", "-59,953", "-82,573", "-176,494"]),
        ("CAPEX",                  ["62,165", "50,850", "47,407", "96,048"]),
        ("FCF",                    ["113,021", "95,241", "174,555", "162,473"]),
        ("Interest-bearing Debt",  ["323,476", "359,141", "371,240", "358,112"]),
        ("Op. Margin (%)",         ["21.8", "20.5", "27.2", "31.6"]),
        ("Net Margin (%)",         ["40.1", "33.9", "18.9", "29.4"]),
        ("ROE (%)",                ["27.9", "26.1", "14.2", "19.9"]),
        ("ROA (%)",                ["13.9", "11.9", "7.3", "10.9"]),
        ("Debt Ratio (%)",         ["91.2", "110.2", "87.0", "74.7"]),
        ("Capital Reserve Ratio (%)",    ["669,911", "705,981", "813,911", "892,030"]),
        ("EPS (CNY)",              ["23.40", "19.67", "12.27", "21.23"]),
        ("PER (x)",                ["14.0", "15.0", "21.8", "18.2"]),
        ("BPS (CNY)",              ["83.92", "75.39", "86.10", "106.49"]),
        ("PBR (x)",                ["3.9", "3.9", "3.1", "3.6"]),
        ("Cash DPS (HKD)",              ["1.60", "2.40", "3.40", "4.50"]),
        ("Cash Div. Yield (%)",         ["0.4", "0.7", "1.2", "1.1"]),
        ("Payout Ratio (%)",       ["5.6", "10.8", "25.2", "19.9"]),
        ("Shares Outstanding",     ["9,608,378,469", "9,568,738,935", "9,391,209,351", "9,142,175,160"]),
    ]
)
