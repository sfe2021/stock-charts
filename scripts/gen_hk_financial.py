...
tencent = build_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["122,341", "113,940", "165,658", "208,786"]),
        ("Pre-tax Income",         ["248,062", "210,225", "161,324", "241,485"]),
