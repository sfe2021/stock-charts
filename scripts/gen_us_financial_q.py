...
vertiv_q = build_q_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["336", "372", "291", "442", "517"]),
        ("Pre-tax Income",         ["265", "268", "265", "421", "492"]),
...
freeport_q = build_q_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["1,243", "1,303", "2,432", "1,972", "811"]),
        ("Pre-tax Income",         ["1,240", "1,291", "2,391", "1,924", "766"]),
        ...
        ("Common Stock",           ["162", "163", "163", "163", "163"]),
        ...
        ("Retention Ratio (%)",    ["10,753", "10,752", "11,071", "11,363", "11,495"]),
...
erocopper_q = build_q_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["45", "43", "48", "38", "142"]),
        ("Pre-tax Income",         ["-55", "95", "84", "49", "102"]),
        ...
        ("Common Stock",           ["287", "287", "287", "291", "298"]),
        ...
        ("Retention Ratio (%)",    ["105", "149", "187", "204", "214"]),
...
teck_q = build_q_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["160", "325", "262", "496", "349"]),
        ("Pre-tax Income",         ["256", "450", "125", "289", "792"]),
        ...
        ("Common Stock",           ["6,441", "6,368", "6,245", "6,218", "6,230"]),
        ...
        ("Retention Ratio (%)",    ["304.9", "305.5", "290.4", "300.8", "302.8"]),
        ("EPS (CAD)",              ["0.51", "0.63", "0.21", "0.27", "1.07"]),
        ("PER (x)",                ["-", "-", "-", "-", "-"]),
        ("BPS (CAD)",              ["51.50", "51.61", "49.70", "51.08", "51.38"]),
        ("PBR (x)",                ["1.12", "1.29", "1.37", "1.35", "1.05"]),
        ("DPS (CAD)",              ["0.33", "0.33", "0.33", "0.33", "0.33"]),
        ("Div. Yield (%)",         ["2.3", "2.0", "1.9", "1.9", "2.4"]),
        ("Payout Ratio (%)",       ["-", "-", "-", "-", "-"]),
