...
vertiv = build_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["214", "260", "223", "872", "1,367"]),
        ("Pre-tax Income",         ["-255", "166", "167", "534", "765"]),
        ...
        ("DPS ($)",                ["0.01", "0.01", "0.01", "0.02", "0.11"]),
        ("Div. Yield (%)",         ["0.1", "0.0", "0.1", "0.0", "0.1"]),
...
freeport = build_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["8,366", "7,037", "6,225", "6,864", "6,518"]),
        ("Pre-tax Income",         ["7,659", "6,715", "6,006", "6,907", "6,372"]),
        ...
        ("Common Stock",           ["160", "161", "162", "162", "163"]),
        ...
        ("Retention Ratio (%)",    ["8,638", "9,562", "10,204", "10,753", "11,495"]),
        ...
        ("DPS ($)",                ["0.38", "0.60", "0.60", "0.60", "0.60"]),
        ("Div. Yield (%)",         ["1.0", "1.7", "1.5", "1.6", "1.2"]),
...
erocopper = build_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["272", "130", "95", "109", "271"]),
        ("Pre-tax Income",         ["237", "126", "112", "-75", "331"]),
        ...
        ("Common Stock",           ["133", "148", "271", "287", "298"]),
        ...
        ("Retention Ratio (%)",    ["195", "264", "197", "105", "214"]),
...
teck = build_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["469", "4,851", "6,986", "222", "-9"]),
        ("Pre-tax Income",         ["-1,044", "4,688", "6,565", "-75", "-718"]),
        ...
        ("Common Stock",           ["6,091", "6,139", "6,139", "6,464", "6,441"]),
        ...
        ("Retention Ratio (%)",    ["228.7", "274.7", "314.9", "317.5", "304.9"]),
        ...
        ("DPS (CAD)",              ["0.20", "0.20", "1.00", "1.00", "1.00"]),
        ("Div. Yield (%)",         ["0.9", "0.6", "2.0", "1.8", "1.7"]),
