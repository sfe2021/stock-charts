...
tokyoelectron = build_html(
    ...
    [
        ...
        ("Operating Income (Reported)",  ["320,686", "599,271", "617,724", "456,264", "697,321"]),
        ("Income Before Tax",         ["317,037", "596,698", "624,856", "473,438", "706,113"]),
        ...
        ("Paid-in Capital",           ["54,961", "54,961", "54,961", "54,961", "54,961"]),
        ...
        ("Capital Reserve Ratio (%)",    ["969,601", "1,292,087", "1,544,563", "1,705,219", "1,800,248"]),
        ...
        ("Cash DPS (\u00a5)",           ["260", "468", "570", "393", "592"]),
        ("Cash Div. Yield (%)",         ["1.7", "2.2", "3.6", "1.0", "3.0"]),
