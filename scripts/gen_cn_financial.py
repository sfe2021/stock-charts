...
catl = build_html(
    ...
    [
        ...
        ("Op. Income (Reported)",  ["35,086", "51,646", "64,544", "81,538"]),
        ("Pre-tax Income",         ["36,673", "53,914", "63,182", "89,527"]),
        ...
        ("Common Stock",           ["2,443", "4,399", "4,403", "4,564"]),
